...
namespace Zuby.ADGV
{
    ...
    public partial class AdvancedDataGridViewSearchToolBar : ToolStrip
    {
        ...
        public void SetColumns(DataGridViewColumnCollection columns)
        {
            ...
            var resources = new ComponentResourceManager(typeof(AdvancedDataGridViewSearchToolBar));
    ...
    public delegate void AdvancedDataGridViewSearchToolBarSearchEventHandler(
        object sender, AdvancedDataGridViewSearchToolBarSearchEventArgs e);
